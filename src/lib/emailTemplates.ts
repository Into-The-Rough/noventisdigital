 ...
 *
 * Each render function returns { subject, text, html } ready to hand to an
 * email provider (Resend or similar). Templates are pure so they can be
 * previewed client-side in /admin/email-preview without any sending.
 */
